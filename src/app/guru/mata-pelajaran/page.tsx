...
export default function MataPelajaranPage() {
  ...
  // Form State - Sudah ditambahkan nama_pengajar
  const [formData, setFormData] = useState({
    nama_mapel: "",
    nama_pengajar: "", // Kolom baru
    kategori: "Umum",
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (editingId) {
      ...
      if (!error) alert("Mata pelajaran berhasil diperbarui!");
    } else {
      // LOGIKA TAMBAH
      const { error } = await supabase
        .from("mapel")
      ...
      if (!error) alert("Mata pelajaran berhasil ditambahkan!");
    }
  ...
  const handleEdit = (item: any) => {
    ...
    setFormData({
      ...
      nama_pengajar: item.nama_pengajar || "", // Ambil data pengajar saat edit
  ...
  return (
    <div className="container-fluid p-0">
            ...
            <div className="modal-content border-0 rounded-4 shadow">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="modal-footer border-0 px-4 pb-4">
                  ...
                  <button type="submit" className="btn btn-success rounded-3 px-4 fw-bold" disabled={isSubmitting}>
      ...
      <button 
        ...
        className="btn btn-success rounded-3 px-4 py-2 fw-bold d-flex align-items-center gap-2 mb-4" 
        style={{ backgroundColor: '#3d8c52' }}
      >
          ...
          <div className="col-md-4" key={item.id}>
            <div className="card border-0 shadow-sm rounded-4 p-4 h-100 position-relative">
              <div className="d-flex justify-content-between align-items-start mb-3">
                <div className="bg-light text-success rounded-3 d-flex align-items-center justify-content-center" style={{ width: '50px', height: '50px' }}>
              ...
              {/* TAMPILAN NAMA PENGAJAR DI KARTU */}
              ...
              <div className="d-flex gap-2 mt-auto">
                <button 
                  ...
                  className="btn btn-outline-success w-100 rounded-3 d-flex align-items-center justify-content-center gap-2 py-2 fw-bold"
                >
                  <i className="bi bi-pencil small"></i> Edit
                </button>
                <button 
                  onClick={() => handleHapus(item.id, item.nama_mapel)}
                  className="btn btn-outline-danger w-100 rounded-3 d-flex align-items-center justify-content-center gap-2 py-2 fw-bold"
                >
